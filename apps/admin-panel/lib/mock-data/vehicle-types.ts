...
export const vehicleBrands: Record<VehicleType, string[]> = {
  "2 Wheeler": ["Honda", "Hero", "Bajaj", "TVS", "Royal Enfield", "Yamaha", "Suzuki"],
  "3 Wheeler": ["Bajaj", "Piaggio", "Mahindra", "TVS", "Atul"],
  "4 Wheeler - Cars": ["Maruti Suzuki", "Hyundai", "Tata", "Honda", "Toyota", "Kia"],
  "4 Wheeler - Commercial Cars": ["Mahindra", "Tata", "Force", "Isuzu", "Ashok Leyland"],
  "4 Wheeler - Trucks": ["Tata", "Mahindra", "Eicher", "BharatBenz", "Ashok Leyland"],
  "6 Wheeler": ["Tata", "Ashok Leyland", "Eicher", "BharatBenz", "Mahindra"],
  "More Than 8 Wheelers": ["Tata", "Ashok Leyland", "BharatBenz", "Eicher", "Mahindra"],
}
