...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter } from "@vehiverze/ui/dialog"
import { vendorSellRequestsDb } from "@/lib/mock-data/vendor-sell-requests"
...
export default function VendorSellRequestDetailPage() {
  ...
  const handleAccept = () => {
    vendorSellRequestsDb.updateStatus(request.id, "Accepted", undefined, adminNote)
  ...
  const handleReject = () => {
    ...
    vendorSellRequestsDb.updateStatus(request.id, "Rejected", rejectionReason, adminNote)
    router.push("/admin/vendor-sell-requests")
  }
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                <div className="w-full h-96 rounded-lg overflow-hidden bg-muted">
                  <Image
                    src={request.images[selectedImageIndex] || "/placeholder.svg"}
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-primary">₹{request.price.toLocaleString()}</p>
                </div>
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href={`tel:${request.vendorPhone}`} className="text-primary hover:underline">
                  {request.vendorPhone}
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-muted-foreground" />
                <a href={`mailto:${request.vendorEmail}`} className="text-primary hover:underline">
                  {request.vendorEmail}
                </a>
              </div>
            ...
            <CardContent className="space-y-4">
              {request.status === "Pending" && (
                <>
                  ...
                  <Button onClick={handleReject} variant="destructive" className="w-full font-semibold">
                    ✕ Reject Request
                  </Button>
                </>
              )}
              ...
              {request.status === "Accepted" && (
                <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                  <p className="text-emerald-600 font-semibold text-center">✓ Accepted & Published</p>
          ...
          {request.status === "Rejected" && request.rejectionReason && (
            <Card className="bg-red-500/5 border-red-500/20">
              <CardHeader>
                <CardTitle className="text-lg text-red-500">Rejection Reason</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-2 gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setEditForm({ ...editForm, kilometersDriven: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setEditForm({ ...editForm, ownershipHistory: e.target.value })}
