        ...
        <Table>
          ...
          <TableBody>
            {currentOrders.map((order) => (
              ...
              >
                <TableCell className="font-medium">{new Date(order.date).toLocaleString()}</TableCell>
                <TableCell>{order.model}</TableCell>
                <TableCell>{order.city}</TableCell>
                <TableCell>
                  <Badge className={`badge ${getTypeColor(order.type)}`}>{order.type}</Badge>
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <Badge className={`badge ${getStatusColor(order.status)}`}>{order.status}</Badge>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
