...
export default function LiveBiddingDetailPage() {
  ...
  const [session, setSession] = useState(
    biddingDb.getById(params.id as string)
  );
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="ml-auto">
          <Badge className={`${statusColors[session.status]} border`}>
            {session.status}
          </Badge>
        </div>
      </div>
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                <div className="w-full h-96 rounded-lg overflow-hidden bg-muted">
                  <Image
                    src={
                      session.images[selectedImageIndex] || "/placeholder.svg"
                    }
          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Badge
                  className={`${statusColors[session.status]} border mt-2`}
                >
                  {session.status}
                </Badge>
              </div>
              ...
              <div>
                ...
                <p className="font-semibold mt-1">
                  {new Date(session.biddingStartTime).toLocaleString()}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-semibold mt-1">
                  {new Date(session.biddingEndTime).toLocaleString()}
                </p>
              </div>
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-3xl font-bold text-emerald-500">
                  ₹{session.highestBid.toLocaleString()}
                </p>
              </div>
