          ...
          <Card className="card-elevated card-hover group overflow-hidden">
            ...
            <CardContent className="relative">
              <div className="flex items-end justify-between">
                ...
                <div
                  className={`flex items-center gap-1 ${postsTrend > 0 ? "text-emerald-500" : "text-destructive"}`}
                >
                  {postsTrend > 0 ? (
          ...
          <Card className="card-elevated card-hover group overflow-hidden">
            ...
            <CardContent className="relative">
              <div className="flex items-end justify-between">
                ...
                <div
                  className={`flex items-center gap-1 ${viewsTrend > 0 ? "text-emerald-500" : "text-destructive"}`}
                >
                  {viewsTrend > 0 ? (
                    <ArrowUpRight className="h-4 w-4" />
                  ) : (
