...
import { mockBlogPosts, mockCategories } from "@/lib/mock-data/blog"
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="section-subheader">View, edit, and delete all your blog posts</p>
          </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border bg-muted/30">
                    ...
                    <th className="text-left py-4 px-4 font-medium hidden lg:table-cell">Tags</th>
                    <th className="text-left py-4 px-4 font-medium">Status</th>
                    <th className="text-left py-4 px-4 font-medium hidden md:table-cell">Views</th>
