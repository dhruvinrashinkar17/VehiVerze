  ...
  { name: "Area", href: "/admin/area", icon: MapPin },
  {
    ...
    subItems: [
      ...
      { name: "Manage Products", href: "/admin/products/manage", icon: List },
      {
        ...
        href: "/admin/products/inspection",
        icon: FileText,
      },
      {
        name: "Inspection Manager",
        href: "/admin/products/inspection-manager",
        icon: Calculator,
      },
    ],
  },
  {
    name: "Vendor Sell Requests",
    href: "/admin/vendor-sell-requests",
    icon: Package,
  },
...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  const handleAuth = () => {
    if (
      authCredentials.id === "KaifAnsari" &&
      authCredentials.password === "Kaif123"
    ) {
  ...
  return (
    <>
      <div
        className={cn(
          "bg-card border-r border-border flex flex-col h-full overflow-hidden shadow-lg",
          "w-64"
        )}
      >
        {/* Logo Section */}
          ...
          <div className="relative bg-card border border-border rounded-2xl shadow-2xl max-w-sm w-full mx-auto p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Enter your credentials to view profit & loss information
              </p>
            </div>
