      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-black/30 p-6 rounded-lg">
            {currentStep === 1 && (
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold mb-4">
                  Selling your {formattedType}{" "}
                  {vehicleDetails.brand && `- ${vehicleDetails.brand}`}
                </h2>
                ...
                <Button
                  ...
                  className="mt-4 bg-[#4ADE80] hover:bg-[#4ADE80]/90"
                >
                  Continue
                </Button>
              </div>
            ...
            {currentStep === 3 && (
              <YearSelector onSelect={handleYearSelect} onBack={handleBack} />
            )}
