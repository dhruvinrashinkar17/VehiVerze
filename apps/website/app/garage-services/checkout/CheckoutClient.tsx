...
export default function CheckoutClient() {
  ...
  const handlePayment = async () => {
    ...
    if (!vehicleDetails || !bookingDetails || selectedServices.length === 0) {
    ...
    try {
      const response = await fetch("/api/garage/bookings", {
        ...
        body: JSON.stringify({
          ...
          bookingDate: bookingDetails.scheduleDate.toISOString(),
          timeSlot: bookingDetails.timeSlot,
          pickupDrop: bookingDetails.pickupDrop,
          additionalNotes: bookingDetails.notes || null,
          customerName: bookingDetails.customerDetails.name,
          mobile: bookingDetails.customerDetails.phone,
          email: bookingDetails.customerDetails.email || null,
      ...
      if (result.success) {
        ...
        // Store final booking for success page
                    ...
                    <Label htmlFor="cash" className="cursor-pointer flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            Pay cash or card at the service center
                          </p>
                        </div>
                      </div>
                    </Label>
