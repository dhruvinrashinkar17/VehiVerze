...
export default function VehicleSelectionClient() {
  ...
  const availableModels = vehicleDetails.brand
    ? vehicleData[vehicleDetails.type as keyof typeof vehicleData]?.models[vehicleDetails.brand] || []
    : []

  const canProceed = () => {
    return vehicleDetails.type && vehicleDetails.brand && vehicleDetails.model && vehicleDetails.registrationNumber
  }
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            <h1 className="text-4xl font-bold text-gray-900">Vehicle Details</h1>
          </div>
          <p className="text-lg text-gray-600">Tell us about your vehicle to get started</p>
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium text-[#1D4ED8]">Vehicle Details</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-500">Service Selection</span>
            </div>
            <div className="w-8 h-px bg-gray-300"></div>
            <div className="flex items-center">
              <div className="w-8 h-8 bg-gray-300 text-gray-500 rounded-full flex items-center justify-center text-sm font-medium">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {vehicleTypes.map((type) => (
                ...
                >
                  <div className="text-3xl mb-2">{vehicleTypeIcons[type as keyof typeof vehicleTypeIcons]}</div>
                  <div className="text-sm font-medium text-center text-card">{type}</div>
                </button>
              ))}
            </div>
          </CardContent>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select value={vehicleDetails.brand} onValueChange={(value) => updateVehicleDetails("brand", value)}>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={vehicleDetails.year} onValueChange={(value) => updateVehicleDetails("year", value)}>
                    <SelectTrigger className="h-12">
          ...
          <Card className="mb-8 shadow-lg border-0 bg-gradient-to-r from-green-50 to-emerald-50">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#1D4ED8]">Available Services</h3>
              </div>
              <p className="mb-4 text-[#1D4ED8]">
                Great choice! We offer comprehensive services for {vehicleDetails.type}s including:
              </p>
        ...
        <div className="flex justify-between items-center">
          <Button variant="outline" onClick={() => router.push("/")} className="px-6 py-3">
            Back to Home
          </Button>
