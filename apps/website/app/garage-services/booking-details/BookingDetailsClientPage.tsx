...
export default function BookingDetailsClientPage() {
  ...
  const updateCustomerDetails = (
    field: keyof BookingDetails["customerDetails"],
    value: string
  ) => {
    setBookingDetails((prev) => ({
      ...prev,
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Schedule your service and provide contact information
            </p>
          </div>
                ...
                <CardContent className="p-6">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            ...
                            >
                              ...
                              {bookingDetails.scheduleDate
                                ? format(bookingDetails.scheduleDate, "PPP")
                                : "Pick a date"}
                            </Button>
                          </PopoverTrigger>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <RadioGroup
                          ...
                          onValueChange={(value) =>
                            updateBookingDetails("timeSlot", value)
                          }
                    ...
                    <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          updateBookingDetails("pickupDrop", checked)
                        }
                      />
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          We'll pick up your vehicle from your location and
                          deliver it back after service
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 text-black">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateBookingDetails("notes", e.target.value)
                      }
                      rows={4}
                      className="mt-2"
                    />
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6 p-4 bg-amber-50 rounded-lg">
                    ...
                    <p className="text-xs text-amber-700">
                      Service will be provided at our authorized service center
                      in {selectedCity}.
                      {bookingDetails.pickupDrop &&
                        " Pickup and drop service is included."}
                    </p>
                  </div>
                </CardContent>
              </Card>
