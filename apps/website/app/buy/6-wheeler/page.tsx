...
export const metadata: Metadata = {
  title:
    "Buy Used 6 Wheeler Trucks Online | Certified Commercial 6 Wheeler Vehicles – Vehiverze",
  description:
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Buy Certified Pre-Owned 6 Wheelers
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              India's Trusted Marketplace for Commercial 6 Wheeler Vehicles
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Buying Used 6 Wheeler Trucks in India
              </h2>
              <div className="prose prose-lg max-w-none text-gray-700">
                <p className="mb-4">
                  Looking to buy a second-hand 6 wheeler truck in India?
                  Vehiverze is your trusted marketplace for certified pre-owned
                  commercial trucks from leading brands like Tata Motors,
                  Eicher, Ashok Leyland, Mahindra, and BharatBenz. We offer an
                  extensive collection of verified commercial vehicles that
                  undergo 100+ point specialized inspection to ensure business
                  readiness and operational efficiency.
                </p>
                <p>
                  Whether you need a goods carrier for transportation business,
                  a tipper for construction work, or a container truck for
                  logistics operations, Vehiverze has the perfect 6 wheeler
                  truck for your commercial needs. With transparent pricing,
                  specialized commercial vehicle financing, and complete permit
                  transfer support, expanding your fleet has never been easier.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Types of Used 6 Wheeler Trucks Available
              </h2>
                ...
                {[
                  {
                    ...
                    description:
                      "6-wheeler trucks for medium cargo transport and city logistics",
                  ...
                  },
                  {
                    ...
                    description:
                      "Commercial goods transportation for inter-city logistics",
                  ...
                  },
                  {
                    title: "Tipper Trucks",
                    description:
                      "Construction and mining tipper vehicles for material transport",
                  ...
                  },
                  {
                    ...
                    description:
                      "Container transportation for port and warehouse operations",
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Popular 6 Wheeler Truck Brands
              </h2>
                ...
                {[
                  {
                    brand: "Tata Motors",
                    description:
                      "India's largest commercial vehicle manufacturer with reliable and durable trucks",
                  ...
                  },
                  {
                    brand: "Eicher Motors",
                    description:
                      "Premium commercial vehicles known for fuel efficiency and driver comfort",
                    popular:
                      "Eicher Pro 1049, Eicher Pro 6025, Eicher Pro 8025",
                  ...
                  },
                  {
                    brand: "Ashok Leyland",
                    description:
                      "Leading commercial vehicle brand with robust and powerful trucks",
                  ...
                  },
                  {
                    ...
                    description:
                      "Innovative commercial vehicles with modern technology and features",
                  ...
                  },
                  {
                    brand: "BharatBenz",
                    description:
                      "Mercedes-Benz technology with Indian engineering for premium trucks",
                  ...
                  },
                  {
                    brand: "Force Motors",
                    description:
                      "Reliable commercial vehicles with strong build quality and performance",
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Buy Used 6 Wheeler Trucks in Top Cities
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  {
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Why Choose Vehiverze for Used 6 Wheeler Trucks?
              </h2>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  {
                    question:
                      "What is the price of a second-hand 6 wheeler truck in India?",
                    answer:
                  ...
                  {
                    question:
                      "Which is the best 6 wheeler truck brand in India?",
                    answer:
                  ...
                  {
                    question:
                      "Do you provide warranty on used 6 wheeler trucks?",
                    answer:
