import { NewVehicleModelsContent } from "@/components/new-vehicle-models-content"
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `New ${categoryFormatted} ${vehicleTypeFormatted} Models | Best Prices & Features | Vehiverze`,
    ...
    openGraph: {
      title: `New ${categoryFormatted} ${vehicleTypeFormatted} Models | Vehiverze`,
...
export default async function NewVehicleModelsPage({ params }: PageProps) {
  const { vehicleType, category } = await params

  return <NewVehicleModelsContent vehicleType={vehicleType} category={category} />
}
