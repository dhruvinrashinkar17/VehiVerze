...
export default function EmiCalculatorPage() {
  ...
  const calculateEMI = () => {
    ...
    const emiValue =
      (principal * ratePerMonth * Math.pow(1 + ratePerMonth, time)) /
      (Math.pow(1 + ratePerMonth, time) - 1);
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-blue-100 text-lg">
                  Get instant EMI calculations for your dream vehicle with our
                  smart calculator
                </p>
              </div>
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      value={[loanAmount]}
                      onValueChange={(value) =>
                        setLoanAmount(value[0] ?? loanAmount)
                      }
                      className="mb-2"
                    />
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      value={[loanTenure]}
                      onValueChange={(value) =>
                        setLoanTenure(value[0] ?? loanTenure)
                      }
                      className="mb-2"
                    />
                    <div className="flex justify-between text-xs text-gray-500">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex justify-between text-xs text-gray-500 mt-1">
                      <span>
                        Principal (
                        {Math.round((loanAmount / totalAmount) * 100)}%)
                      </span>
                      <span>
                        Interest (
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="p-6 space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-black">
                      Mar 10, {2025 + Math.floor(loanTenure / 12)}
                    </span>
                  </div>
                  <div className="flex justify-between">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">
                EMI (Equated Monthly Installment) is the fixed amount that you
                pay to the lender each month until the loan is fully paid off.
                It consists of the interest on loan as well as part of the
            ...
            <div>
              ...
              <p className="text-gray-600">
                EMI is calculated using the formula: P × r × (1 + r)^n / ((1 +
                r)^n - 1) where P is the loan amount, r is the interest rate per
                month, and n is the number of monthly installments.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-800">
